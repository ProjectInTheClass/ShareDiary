...
var groupDummies: [Group] = [
    Group(id: "",
          groupName: "EOS", //elVug0rGjegkC2f8ibVq
    ...
    Group(id: "",
          groupName: "알로하", // nuv0i2Y6Noi5R68Ckf1T
    ...
    Group(id: "",
          groupName: "2022소프트웨어스튜디오", // gUw4ilJm3pJH8dCP7doE
...
var diaryDummies: [Diary] = [
    Diary(id: "",
          authorId: "MItGBOf72ZUwLBtOeUfSdGyaUEI2",
          date: Calendar.current.date(from: DateComponents(year: 2022, month: 04, day: 5))!,
          tag: ["공부"],
          sharedGroupId: ["gUw4ilJm3pJH8dCP7doE"],
          imageUrls: ["images/mbWmZzuzu9bophsgF6vv_0.jpg"],
          videoUrls: [],
          text: "HIG 언제 다 듣지?",
          emotion: "😅"),
    Diary(id: "",
          authorId: "NoatdXKDhdR6wiSQ2Sr2WU4nBXM2",
          ...
          emotion: "😄"),
    Diary(id: "",
          authorId: "afUVm4PXoCaxFQNSphCmp5h4W5l1",
          ...
          emotion: "😁"),
    Diary(id: "",
          authorId: "4BtLUTwpAjNeZbey4BQ0twGkKvw2",
